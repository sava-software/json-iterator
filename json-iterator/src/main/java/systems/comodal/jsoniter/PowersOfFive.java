...
/// 128-bit truncated powers of five used by the Eisel-Lemire algorithm in
/// [DoubleParser]. Two longs per entry (upper, lower 64 bits) for exponents
/// [MIN_POWER_OF_FIVE, 308]. Table values from simdjson-java
/// (https://github.com/simdjson/simdjson-java, Apache License 2.0).
final class PowersOfFive {
